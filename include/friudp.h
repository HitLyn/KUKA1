...
****************************************************************************
  friUdp.h
      ...
      NOTE: This sample, as the corresponding FRI (Fast Research interface) is subject to radical change
...
/** Receive Timestamp. This mechanism works under
QNX and Linux(?) but not under Windows and under VxWorks.
*/

//! \brief KUKA data structure
typedef struct
{
    tFriMsrData load;
...
\author Guenter Schreiber <guenter(AT)jacobus>
*/
//! \brief KUKA/DLR class
class friUdp{
public:
